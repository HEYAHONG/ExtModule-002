...
#ifdef FS_USE_RAID
#define hal_fs_get_free_size_entry     fsr_get_free_size
#define hal_fs_garbage_collect_entry   fsr_garbage_collect
#define hal_fs_item_write_entry 	     fsr_item_write
#define hal_fs_init_entry              fsr_init
#define hal_fs_item_read_entry         fsr_item_read
#define hal_fs_item_del_entry          fsr_item_del
#define hal_fs_get_garbage_size_entry  fsr_get_garbage_size

#else
#define hal_fs_get_free_size_entry   hal_fs_get_free_size
#define hal_fs_garbage_collect_entry	hal_fs_garbage_collect
#define hal_fs_item_write_entry 	 		hal_fs_item_write
#define hal_fs_init_entry 						hal_fs_init
#define hal_fs_item_read_entry        hal_fs_item_read
#define hal_fs_item_del_entry         hal_fs_item_del
#define hal_fs_get_garbage_size_entry  hal_fs_get_garbage_size
