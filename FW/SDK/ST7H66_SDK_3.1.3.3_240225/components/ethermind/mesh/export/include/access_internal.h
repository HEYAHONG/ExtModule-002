...
#endif /* ACCESS_DEBUG */
#define MS_S_MAX_ACCESS_ELEMENT_COUNT               5
#define MS_S_MAX_ACCESS_MODEL_COUNT                 20
#define MS_S_MAX_SUBNETS                            3
#define MS_S_MAX_LPNS                               5
#define MS_S_MAX_DEV_KEYS                           64
#define MS_S_MAX_APPS                               5
#define MS_S_MAX_VIRTUAL_ADDRS                      3
#define MS_S_MAX_NON_VIRTUAL_ADDRS                  32
#define MS_S_MAX_PROXY_FILTER_LIST_SIZE             16



/**Support max Size */
#define MS_PS_RECORD_ELEMENTS_MAXSIZE               ((((sizeof(UINT16) + (sizeof(MS_ACCESS_ELEMENT_TYPE) * MS_CONFIG_LIMITS(MS_S_MAX_ACCESS_ELEMENT_COUNT)) + sizeof(composition_data_hdr))+3)>>2)<<2)
#define MS_PS_RECORD_MODELS_MAXSIZE                 ((((sizeof(UINT16) + (MS_ACCESS_MODEL_TYPE_SIZE * (MS_CONFIG_LIMITS(MS_S_MAX_ACCESS_MODEL_COUNT))))+3)>>2)<<2)
#define MS_PS_RECORD_SUBNETS_MAXSIZE                ((((sizeof(UINT16) + sizeof(ms_iv_index)  + sizeof(ms_netkey_count) + (MS_NETKEY_ENTRY_SIZE * (MS_CONFIG_LIMITS(MS_S_MAX_SUBNETS) + MS_CONFIG_LIMITS(MS_S_MAX_LPNS))) \
                                                        +(sizeof(MS_NET_ADDR) * MS_CONFIG_LIMITS(MS_S_MAX_DEV_KEYS)) + sizeof(UINT16))+3)>>2)<<2)
#define MS_PS_RECORD_DEV_KEYS_MAXSIZE               ((((sizeof(UINT16) + sizeof(UINT16) + sizeof(UINT16) + (sizeof(MS_DEV_KEY_ENTRY) * MS_CONFIG_LIMITS(MS_S_MAX_DEV_KEYS)))+3)>>2)<<2)
#define MS_PS_RECORD_APP_KEYS_MAXSIZE               ((((sizeof(UINT16) + (sizeof(MS_APPKEY_ENTRY) * MS_CONFIG_LIMITS(MS_S_MAX_APPS)))+3)>>2)<<2)
#define MS_PS_RECORD_ELEMENT_ADDRS_MAXSIZE          ((((sizeof(UINT16) + (sizeof(MS_ELEMENT_ADDR_ENTRY) * (1 + MS_CONFIG_LIMITS(MS_S_MAX_LPNS))))+3)>>2)<<2)
#define MS_PS_RECORD_VIRTUAL_ADDRS_MAXSIZE          ((((sizeof(UINT16) + (sizeof(MS_VIRTUAL_ADDR_ENTRY) * MS_CONFIG_LIMITS(MS_S_MAX_VIRTUAL_ADDRS)))+3)>>2)<<2)
#define MS_PS_RECORD_NON_VIRTUAL_ADDRS_MAXSIZE      ((((sizeof(UINT16) + (sizeof(MS_NON_VIRTUAL_ADDR_ENTRY) * MS_CONFIG_LIMITS(MS_S_MAX_NON_VIRTUAL_ADDRS)))+3)>>2)<<2)
#define MS_PS_RECORD_SEQ_NUMBER_MAXSIZE             ((((sizeof(UINT32 /* net_seq_number_state.block_seq_num_max */))+3)>>2)<<2)
#define MS_PS_RECORD_TX_STATES_FEATURES_MAXSIZE     ((((sizeof(UINT16) + sizeof(ms_tx_state) + sizeof(ms_features))+3)>>2)<<2)
#define MS_PS_RECORD_PROVISIONER_ADDR_MAXSIZE       (((sizeof(UINT16)  +3)>>2)<<2)

#define MS_PS_RECORD_PROXY_FILTER_ADDR_MAXSIZE      (((sizeof(MS_NET_ADDR)*MS_CONFIG_LIMITS(MS_S_MAX_PROXY_FILTER_LIST_SIZE) +3)>>2)<<2)
...
/** Size */
#define MS_PS_RECORD_ELEMENTS_SIZE                  ((((sizeof(UINT16) + (sizeof(MS_ACCESS_ELEMENT_TYPE) * MS_CONFIG_LIMITS(MS_ACCESS_ELEMENT_COUNT)) + sizeof(composition_data_hdr))+3)>>2)<<2)
#define MS_PS_RECORD_MODELS_SIZE                    ((((sizeof(UINT16) + (MS_ACCESS_MODEL_TYPE_SIZE * (MS_CONFIG_LIMITS(MS_ACCESS_MODEL_COUNT))))+3)>>2)<<2)
#define MS_PS_RECORD_SUBNETS_SIZE                   ((((sizeof(UINT16) + sizeof(ms_iv_index)  + sizeof(ms_netkey_count) + (MS_NETKEY_ENTRY_SIZE * (MS_CONFIG_LIMITS(MS_MAX_SUBNETS) + MS_CONFIG_LIMITS(MS_MAX_LPNS))) \
                                                        +(sizeof(MS_NET_ADDR) * MS_CONFIG_LIMITS(MS_MAX_DEV_KEYS)) + sizeof(UINT16))+3)>>2)<<2)
#define MS_PS_RECORD_DEV_KEYS_SIZE                  ((((sizeof(UINT16) + sizeof(UINT16) + sizeof(UINT16) + (sizeof(MS_DEV_KEY_ENTRY) * MS_CONFIG_LIMITS(MS_MAX_DEV_KEYS)))+3)>>2)<<2)
#define MS_PS_RECORD_APP_KEYS_SIZE                  ((((sizeof(UINT16) + (sizeof(MS_APPKEY_ENTRY) * MS_CONFIG_LIMITS(MS_MAX_APPS)))+3)>>2)<<2)
#define MS_PS_RECORD_ELEMENT_ADDRS_SIZE             ((((sizeof(UINT16) + (sizeof(MS_ELEMENT_ADDR_ENTRY) * (1 + MS_CONFIG_LIMITS(MS_MAX_LPNS))))+3)>>2)<<2)
#define MS_PS_RECORD_VIRTUAL_ADDRS_SIZE             ((((sizeof(UINT16) + (sizeof(MS_VIRTUAL_ADDR_ENTRY) * MS_CONFIG_LIMITS(MS_MAX_VIRTUAL_ADDRS)))+3)>>2)<<2)
#define MS_PS_RECORD_NON_VIRTUAL_ADDRS_SIZE         ((((sizeof(UINT16) + (sizeof(MS_NON_VIRTUAL_ADDR_ENTRY) * MS_CONFIG_LIMITS(MS_MAX_NON_VIRTUAL_ADDRS)))+3)>>2)<<2)
#define MS_PS_RECORD_SEQ_NUMBER_SIZE                ((((sizeof(UINT32 /* net_seq_number_state.block_seq_num_max */))+3)>>2)<<2)
#define MS_PS_RECORD_TX_STATES_FEATURES_SIZE        ((((sizeof(UINT16) + sizeof(ms_tx_state) + sizeof(ms_features))+3)>>2)<<2)
#define MS_PS_RECORD_PROVISIONER_ADDR_SIZE          (((sizeof(UINT16)  +3)>>2)<<2)

#define MS_PS_RECORD_PROXY_FILTER_ADDR_SIZE          (((sizeof(MS_NET_ADDR)*MS_CONFIG_LIMITS(MS_PROXY_FILTER_LIST_SIZE) +3)>>2)<<2)


/** Offset */
#define MS_PS_RECORD_ELEMENTS_OFFSET                0
#define MS_PS_RECORD_MODELS_OFFSET                  (MS_PS_RECORD_ELEMENTS_OFFSET          + MS_PS_RECORD_ELEMENTS_MAXSIZE)
#define MS_PS_RECORD_SUBNETS_OFFSET                 (MS_PS_RECORD_MODELS_OFFSET            + MS_PS_RECORD_MODELS_MAXSIZE)
#define MS_PS_RECORD_DEV_KEYS_OFFSET                (MS_PS_RECORD_SUBNETS_OFFSET           + MS_PS_RECORD_SUBNETS_MAXSIZE)
#define MS_PS_RECORD_APP_KEYS_OFFSET                (MS_PS_RECORD_DEV_KEYS_OFFSET          + MS_PS_RECORD_DEV_KEYS_MAXSIZE)
#define MS_PS_RECORD_ELEMENT_ADDRS_OFFSET           (MS_PS_RECORD_APP_KEYS_OFFSET          + MS_PS_RECORD_APP_KEYS_MAXSIZE)
#define MS_PS_RECORD_VIRTUAL_ADDRS_OFFSET           (MS_PS_RECORD_ELEMENT_ADDRS_OFFSET     + MS_PS_RECORD_ELEMENT_ADDRS_MAXSIZE)
#define MS_PS_RECORD_NON_VIRTUAL_ADDRS_OFFSET       (MS_PS_RECORD_VIRTUAL_ADDRS_OFFSET     + MS_PS_RECORD_VIRTUAL_ADDRS_MAXSIZE)
#define MS_PS_RECORD_SEQ_NUMBER_OFFSET              (MS_PS_RECORD_NON_VIRTUAL_ADDRS_OFFSET + MS_PS_RECORD_NON_VIRTUAL_ADDRS_MAXSIZE)
#define MS_PS_RECORD_TX_STATES_FEATURES_OFFSET      (MS_PS_RECORD_SEQ_NUMBER_OFFSET        + MS_PS_RECORD_SEQ_NUMBER_MAXSIZE)
#define MS_PS_RECORD_PROVISIONER_ADDR_OFFSET        (MS_PS_RECORD_TX_STATES_FEATURES_OFFSET + MS_PS_RECORD_TX_STATES_FEATURES_MAXSIZE)

#define MS_PS_RECORD_PROXY_FILTER_ADDR_OFFSET       (MS_PS_RECORD_PROVISIONER_ADDR_OFFSET + MS_PS_RECORD_PROVISIONER_ADDR_MAXSIZE)

/* Macro definition for the total size of the Access Layer Persistent Storage. */
#define MS_PS_RECORD_CORE_MODULES_OFFSET           (MS_PS_RECORD_PROXY_FILTER_ADDR_OFFSET + MS_PS_RECORD_PROXY_FILTER_ADDR_MAXSIZE)
...
extern UINT8   ms_ps_count;


/** Maximum number of Records in Persistent Storage */
#define MS_PS_ACCESS_MAX_RECORDS       12
...
#define MS_PS_RECORD_PROVSIONER_ADDR    0x00000400
#define MS_PS_RECORD_PROXY_FILTER_ADDR  0x00000800
...
MS_DECLARE_GLOBAL_ARRAY(MS_ACCESS_MODEL_TYPE, ms_access_model_list, MS_CONFIG_LIMITS(MS_ACCESS_MODEL_COUNT));
...
MS_DECLARE_GLOBAL_ARRAY(MS_APPKEY_ENTRY, ms_appkey_table, MS_CONFIG_LIMITS(MS_MAX_APPS));
...
/* Module Mutex */
MS_DEFINE_MUTEX_TYPE(extern, access_mutex);

/** Elemement List */
MS_DECLARE_GLOBAL_ARRAY(MS_ACCESS_ELEMENT_TYPE, ms_access_element_list, MS_CONFIG_LIMITS(MS_ACCESS_ELEMENT_COUNT));
...
*/
MS_DECLARE_GLOBAL_ARRAY(MS_ELEMENT_ADDR_ENTRY, ms_element_addr_table, 1 + MS_CONFIG_LIMITS(MS_MAX_LPNS));
...
*/
MS_DECLARE_GLOBAL_ARRAY(MS_NETKEY_ENTRY, ms_subnet_table, MS_CONFIG_LIMITS(MS_MAX_SUBNETS) + MS_CONFIG_LIMITS(MS_MAX_LPNS));
extern UINT16          ms_netkey_count;

/**
    List of Key Refresh whitelist table.
*/
MS_DECLARE_GLOBAL_ARRAY(MS_NET_ADDR, ms_key_refresh_whitelist, (MS_CONFIG_LIMITS(MS_MAX_DEV_KEYS)));
extern UINT16          ms_key_refresh_count;

/** List of Device Key Entries */
MS_DECLARE_GLOBAL_ARRAY(MS_DEV_KEY_ENTRY, ms_dev_key_table, MS_CONFIG_LIMITS(MS_MAX_DEV_KEYS));

/** Count of valid Device Key Entries */
extern UINT16 ms_dev_key_table_entries;

/** Count of Device Key Pointer Entries */
extern UINT16 ms_dev_key_table_pointer;


/** List of Virtual Address Entries */
MS_DECLARE_GLOBAL_ARRAY(MS_VIRTUAL_ADDR_ENTRY, ms_virtual_addr_table, MS_CONFIG_LIMITS(MS_MAX_VIRTUAL_ADDRS));

/** List of non-Virtual Address Entries */
MS_DECLARE_GLOBAL_ARRAY(MS_NON_VIRTUAL_ADDR_ENTRY, ms_non_virtual_addr_table, MS_CONFIG_LIMITS(MS_MAX_NON_VIRTUAL_ADDRS));
...
extern UINT8 ms_max_apps;

extern UINT8 ms_max_virtual_addrs;
extern UINT8 ms_max_non_virtual_addrs;
...
extern UINT8 ms_access_element_count;
extern UINT8 ms_access_model_count;
extern UINT8 ms_max_subnets,ms_max_lpns;
