...
/* --------------------------------------------- Function */
void appl_sensor_states_initialization(void)
{
    UINT32 index;
    #if 0
    ...
    for (index = 0; index < MS_MAX_SENSOR_SETTINGS; index++)
    {
        ...
        printf("seee %x %x\n",appl_sensor_setting_raw[0][index][0],appl_sensor_settings[0][index].sensor_setting_access);
...
void appl_sensor_state_get(UINT16 state_t, UINT16 state_inst, void* param, UINT8 direction)
{
    printf("appl_sensor_state_get\n");
    API_RESULT retval;
    UINT16     sensor_propery_index;
    ...
    {
        printf("MS_STATE_SENSOR_SERIES_COLUMN_T\n");
    ...
    {
        printf("MS_STATE_SENSOR_SERIES_T\n");
        MS_STATE_SENSOR_SERIES_COLUMN_STRUCT* param_p;
        param_p = (MS_STATE_SENSOR_SERIES_COLUMN_STRUCT*)param;
        /* Ignoring Instance and direction right now */
        /* *param_p = appl_sensor_series[0]; */
...
void appl_sensor_state_set(UINT16 state_t, UINT16 state_inst, void* param, UINT8 direction)
{
    printf("appl_sensor_state_set\n");
    API_RESULT retval;
    UINT16     sensor_propery_index;
    UINT16     setting_propery_index;
