/*******************************************************************************************************
    -----------------------------------------------------------------------------------------------------
    @file      :    FileName sbc multi role scheduler .h file

    @date      :    2020-12-4
    @brief     :    used to schedule the sbc multi role task list
    @attention :
    -----------------------------------------------------------------------------------------------------
...
#ifndef _SBC_MULTI_SCHEDULE_H
#define _SBC_MULTI_SCHEDULE_H
