...
//	
//	
//	#define PIN_TOUCH_KEY P20
//			hal_gpio_pin_init(PIN_TOUCH_KEY, IE);
//			hal_gpio_pull_set(PIN_TOUCH_KEY, STRONG_PULL_UP);
//			pwroff_cfg_t power_io_cfg[1] = {
//					PIN_TOUCH_KEY, POL_FALLING, 1
//			};
//			hal_pwrmgr_poweroff(power_io_cfg,1);	
