...
then
	...
	rsync -rl --progress --delete --exclude='rom' --exclude='.git' --exclude='*.png' --exclude='*.jpg' --exclude="htools"  --exclude="hcppbox" --exclude="hrc"  --exclude="hplatformbox" --exclude="doc" --exclude="test" --exclude="*.md"  "${script_dir}/HCppBox/" "${script_dir}/master/"
fi 
